...
.login {
  @apply mx-auto h-1/5 w-1/4 justify-center rounded-3xl bg-zinc-900 p-16 text-center;
}
.title {
...
.submit {
  @apply h-14 w-full cursor-pointer rounded-lg bg-white font-medium hover:bg-red-500 hover:text-white hover:shadow-md hover:shadow-zinc-900;
}
</style>
